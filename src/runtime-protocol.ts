/**
 * Runtime Protocol v2 Types
 *
 * This module defines the canonical runtime protocol types for the Pi WebUI/runtime migration.
 ...
 */
export type RuntimeMessagePart = TextPart | ReasoningPart | ToolCallPart | ToolResultPart;
